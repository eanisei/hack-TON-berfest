import {
  require_dist,
  require_dist2
} from "./chunk-X5QDRMDY.js";
import "./chunk-6LEERMLI.js";
import {
  __commonJS,
  import_buffer,
  import_process,
    ...
    var ElectorContract = class _ElectorContract {
      ...
      async getComplaints(provider, electionId) {
        ...
        while (complaintsRaw.remaining > 0) {
          ...
          const publicKey = import_buffer.Buffer.from(unpackedComplaints.readBigNumber().toString(16), "hex");
          ...
          const rewardAddress = new ton_core_1.Address(-1, import_buffer.Buffer.from(unpackedComplaints.readBigNumber().toString(16), "hex"));
